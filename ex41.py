...
def princess_lives_here():
	"""You see a beatiful Princess with a shiny crown.
	She offers you some cake.
	"""
	princess_lives_here.__doc__
	eat_it = raw_input("> ")
	

	if eat_it == "eat it":
		print "You explode like a pinata full of frogs."
		print "The Princess cackles and eat the frogs. Yum!"
		return "death"
...
def gold_koi_pond():
	...
	if feed_it == "feed_it":
		...
		print "I rushes to the otherend of the pond, braces against the wall..."
		print "then it *lunges* out of the water, up inthe air and over your\nentire body, cake and all.\nYou are then pooped out a week later."
		return 'death'
...
def bear_with_sword():
	...
	if give_it == "give it":
		...
		print '"Is is because it\'s not a katana? I could go get one!"'
		print "It then runs off and now yo notic a big iron gate."
		print '"Where the hell did that come from?" You say.'
		return 'big_iron_gate'
	else:
		print "The bear look puzzzled as to why you'd do that."
		return "bear_with_sword"

def big_iron_gate():
	"""You walk up to the big gate and see there's a handle.
	"""
	big_iron_gate.__doc__
	open_it = raw_input("> ")
